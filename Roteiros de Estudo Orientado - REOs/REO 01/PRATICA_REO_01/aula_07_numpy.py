...
print('-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=')
print('-----------------------------------------------------------------------------------------------------------------')
print('Exemplo 05 - Array Multidimensional - Matriz')
print('-----------------------------------------------------------------------------------------------------------------')
import numpy as np
...
'''
print('-----------------------------------------------------------------------------------------------------------------')
print('Exemplo 06 - Operações Matemáticas e Matriciais')
print('-----------------------------------------------------------------------------------------------------------------')
# Importação
import numpy as np
...
print('Matriz vezes 10')
print(matriz_x10)
matriz_quadrados = matriz**2
print('')
print('Matriz elevado ao quadrado')
print(matriz_quadrados)
print('-----------------------------------------------------------------------------------------------------------------')
# Operações matriciais
vetor_linha = np.array([1,1])
print('Dimensão vetor_linha: ',np.shape(vetor_linha))
vetor_coluna = np.reshape(vetor_linha,(2,1))
print('Dimensão vetor_coluna: ',np.shape(vetor_coluna))
print('-----------------------------------------------------------------------------------------------------------------')
matriz_2x3 = np.array([[10,10,10],[100,100,100]])
print('Matriz')
print(matriz)
print('')
print('Matriz 2x3')
print(matriz_2x3)
matriz_produto = matriz.dot(matriz_2x3)
print('')
...
'''
print('-----------------------------------------------------------------------------------------------------------------')
print('Exemplo Extra - Operações Matriciais')
print('-----------------------------------------------------------------------------------------------------------------')
import numpy as np
...
'''
print('-----------------------------------------------------------------------------------------------------------------')
print('Exemplo 07 - Criação Automática de Matrizes e Vetores')
print('-----------------------------------------------------------------------------------------------------------------')
import numpy as np
...
'''
print('-----------------------------------------------------------------------------------------------------------------')
print('Exemplo 08 - Leitura de dados txt')
print('-----------------------------------------------------------------------------------------------------------------')
import numpy as np
