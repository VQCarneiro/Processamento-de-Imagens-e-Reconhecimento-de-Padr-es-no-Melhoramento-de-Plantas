...
limiar_Cb = 150
(L, img_limiar) = cv2.threshold(Cb,limiar_Cb,255,cv2.THRESH_BINARY)
(L, img_limiar_inv) = cv2.threshold(Cb,limiar_Cb,255,cv2.THRESH_BINARY_INV)
...
plt.axvline(x=limiar_Cb,color = 'r')
...
plt.title('Limiar: ' + str(limiar_Cb))
